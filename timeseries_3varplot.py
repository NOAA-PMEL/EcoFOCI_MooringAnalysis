...
from plots.instrument_plot import Timeseries3varPlot 
...
try:
    ...
    t1 = p1.add_title(mooringid=global_atts['MOORING'],
                             ...
                             depth=ncdata['depth'][0],
                             instrument=args.instname)    
plt1, fig1 = p1.plot(nctime, 
                     ncdata[args.epickey[0]][:,0,0,0], 
                     ncdata[args.epickey[1]][:,0,0,0], 
                     ncdata[args.epickey[2]][:,0,0,0], 
                     ylabel=args.epickey[0], ylabel2=args.epickey[1], ylabel3=args.epickey[2])
