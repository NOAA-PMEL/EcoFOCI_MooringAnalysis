...
parser.add_argument("cdm_data_type",metavar='cdm_data_type', 
    type=str, 
...
parser.add_argument("ind_val", metavar='ind_val',
    type=str,
...
try:
    ...
    print("Dimension: {0}, Variable: {1} - not added".format(args.cdm_data_type,args.ind_dim))

#fill with default values
print args.ind_val
nchandle.variables[id_name][:]=stringtochar(np.array(len(nchandle.dimensions[args.ind_dim]) * [args.ind_val]))
