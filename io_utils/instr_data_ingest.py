...
"""
 ...
 2019-05-30: update all print statements to be python3 compatible
...
def data_source_instrumentconfig(ftype="yaml"):
    ...
    if ftype in ["json", "pyini"]:
        sources = {
            "seacat": "sbe16_epickeys.json",
            "sbe16": "sbe16_epickeys.json",
            "sbe-16": "sbe16_epickeys.json",
            "SBE16": "sbe16_epickeys.json",
            "SBE-16": "sbe16_epickeys.json",
            "sc": "sbe16_epickeys.json",
            "sbe26": "sbe26_epickeys.json",
            "sbe-26": "sbe26_epickeys.json",
            "SBE26": "sbe26_epickeys.json",
            "SBE-26": "sbe26_epickeys.json",
            "s26": "sbe26_epickeys.json",
            "microcat": "sbe37_epickeys.json",
            "sbe37": "sbe37_epickeys.json",
            "sbe-37": "sbe37_epickeys.json",
            "SBE37": "sbe37_epickeys.json",
            "SBE-37": "sbe37_epickeys.json",
            "s37": "sbe37_epickeys.json",
            "sbe39": "sbe39_epickeys.json",
            "sbe-39": "sbe39_epickeys.json",
            "SBE39": "sbe39_epickeys.json",
            "SBE-39": "sbe39_epickeys.json",
            "s39": "sbe39_epickeys.json",
            "sbe56": "sbe56_epickeys.json",
            "sbe-56": "sbe56_epickeys.json",
            "SBE56": "sbe56_epickeys.json",
            "SBE-56": "sbe56_epickeys.json",
            "s56": "sbe56_epickeys.json",
            "rcm7": "rcm_epickeys.json",
            "rcm9": "rcm_epickeys.json",
            "rcm11": "rcm_epickeys.json",
            "sg": "rcmsg_epickeys.json",
            "rcmsg": "rcmsg_epickeys.json",
            "rcm-sg": "rcmsg_epickeys.json",
            "rcm_sg": "rcmsg_epickeys.json",
            "sg": "rcmsg_epickeys.json",
            "wpak": "wpak_epickeys.json",
            "met": "wpak_epickeys.json",
            "atrh": "atrh",
            "prawler_met": "atrh",
            "par": "par",
            "isus": "isus",
            ...
            "lwrcp": "adcp",
            "wcp": "adcp",
            "adcp_ice": "adcp_bottom_tracking_epickeys.json",
            "mtr": "mtr_epickeys.json",
            "MTR": "mtr_epickeys.json",
            "mtrduino": "mtr_epickeys.json",
            "MTR5k": "mtr_epickeys.json",
            "eco": "fluor_std_epickeys.json",
            "ecf": "fluor_std_epickeys.json",
            "ecoflsb": "fluor_std_epickeys.json",
            "ecofluor": "eco_epickeys",
        ...
        sources = {
            "seacat": "sbe16_epickeys.yaml",
            "sbe16": "sbe16_epickeys.yaml",
            "sbe-16": "sbe16_epickeys.yaml",
            "SBE16": "sbe16_epickeys.yaml",
            "SBE-16": "sbe16_epickeys.yaml",
            "sc": "sbe16_epickeys.yaml",
            "sbe26": "sbe26_epickeys.yaml",
            "sbe-26": "sbe26_epickeys.yaml",
            "SBE26": "sbe26_epickeys.yaml",
            "SBE-26": "sbe26_epickeys.yaml",
            "s26": "sbe26_epickeys.json",
            "microcat": "sbe37_epickeys.yaml",
            "sbe37": "sbe37_epickeys.yaml",
            "sbe-37": "sbe37_epickeys.yaml",
            "SBE37": "sbe37_epickeys.yaml",
            "SBE-37": "sbe37_epickeys.yaml",
            "s37": "sbe37_epickeys.yaml",
            "sbe39": "sbe39_epickeys.yaml",
            "sbe-39": "sbe39_epickeys.yaml",
            "SBE39": "sbe39_epickeys.yaml",
            "SBE-39": "sbe39_epickeys.yaml",
            "s39": "sbe39_epickeys.yaml",
            "sbe56": "sbe56_epickeys.yaml",
            "sbe-56": "sbe56_epickeys.yaml",
            "SBE56": "sbe56_epickeys.yaml",
            "SBE-56": "sbe56_epickeys.yaml",
            "s56": "sbe56_epickeys.yaml",
            "rcm7": "rcm_epickeys.yaml",
            "rcm9": "rcm_epickeys.yaml",
            "rcm11": "rcm_epickeys.yaml",
            "sg": "rcmsg_epickeys.yaml",
            "rcmsg": "rcmsg_epickeys.yaml",
            "rcm-sg": "rcmsg_epickeys.yaml",
            "rcm_sg": "rcmsg_epickeys.yaml",
            "sg": "rcmsg_epickeys.yaml",
            "wpak": "wpak_epickeys.yaml",
            "met": "wpak_epickeys.yaml",
            "atrh": "atrh",
            "prawler_met": "atrh",
            "par": "par",
            "isus": "isus",
            ...
            "lwrcp": "adcp",
            "wcp": "adcp",
            "adcp_ice": "adcp_bottom_tracking_epickeys.yaml",
            "mtr": "mtr_epickeys.yaml",
            "MTR": "mtr_epickeys.yaml",
            "mtrduino": "mtr_epickeys.yaml",
            "MTR5k": "mtr_epickeys.yaml",
            "eco": "fluor_std_epickeys.yaml",
            "ecf": "fluor_std_epickeys.yaml",
            "ecoflsb": "fluor_std_epickeys.yaml",
            "ecofluor": "eco_epickeys",
...
class mtr(object):
    ...
    def parse(fobj, add_seconds=0, **kwargs):
        ...
        for sam_num in declines:
            for k, v in declines[sam_num].items():
                if not k == "time":
                    declines[sam_num][k] = [
                        mtr.steinhart_hart(x, kwargs["mtr_coef"])
                        for x in declines[sam_num][k]
                    ]
        ...
        add_delta_seconds = float(add_seconds) / (
            (date_diff.days * 24.0 * 60.0 * 60.0) + date_diff.seconds
        )
        time_orig = np.min(time.values())
        time_corr = {
            k: linear_clock_adjust(time_orig, v, add_delta_seconds)
    ...
    @staticmethod
    def MTRhex2dec(data_dic, model_factor=4.0e08):
        """
...
class mtrduino(object):
    ...
    def parse(fobj, **kwargs):
        ...
        rawdata = pd.read_csv(
            fobj, delimiter=",", parse_dates=["date_time"], index_col="date_time"
        )
        ...
        return {
            "time": rawdata["date_time"].to_dict(into=OrderedDict),
    ...
    def parse(fobj, prawler_interp_time=False, prawler_grid_press=True, FillGaps=True):
        ...
        for k, line in enumerate(fobj.readlines()):
            ...
            if (k >= startrow) and (startrow != "") and data_field:
                ...
                SigmaT = SigmaT + [
                    sw.eos80.dens0(
                        np.float(line.strip().split()[6]),
                        np.float(line.strip().split()[4]),
                    )
                    - 1000.0
                ]
                DO_Sat = DO_Sat + [
                    oxy_percent_sat(
                        np.float(line.strip().split()[4]),
                        np.float(line.strip().split()[6]),
                        np.float(line.strip().split()[3]),
                        np.float(line.strip().split()[7]),
                    )
                ]
        ...
        if prawler_grid_press:
            ...
            for k in data_dic.keys():
                ...
                cast_date = mpl.dates.date2num(
                    datetime.datetime.strptime(
                        data_dic[k][0]["Date"][0] + " " + data_dic[k][0]["Time"][0],
                        "%Y-%m-%d %H:%M:%S",
                    )
                )
                for pg in press_grid:
                    ireg_ind = np.where(
                        (irreg_depth > pg)
                        & (irreg_depth <= pg + pressure_grid_interval)
                    )
                    mesh_depth_s = np.hstack(
                        (mesh_depth_s, np.median(irreg_sal[ireg_ind]))
                    )
                    mesh_depth_sig = np.hstack(
                        (mesh_depth_sig, np.median(irreg_sigmat[ireg_ind]))
                    )
                    mesh_depth_t = np.hstack(
                        (mesh_depth_t, np.median(irreg_temp[ireg_ind]))
                    )
                    mesh_depth_o = np.hstack(
                        (mesh_depth_o, np.median(irreg_oxy[ireg_ind]))
                    )
                    mesh_depth_osat = np.hstack(
                        (mesh_depth_osat, np.median(irreg_osat[ireg_ind]))
                    )
                    mesh_depth_chl = np.hstack(
                        (mesh_depth_chl, np.median(irreg_chlor[ireg_ind]))
                    )
                    mesh_depth_turb = np.hstack(
                        (mesh_depth_turb, np.median(irreg_turb[ireg_ind]))
                    )
                    mesh_depth_stats = np.hstack((mesh_depth_stats, ireg_ind[0].size))

                if FillGaps:
                    mask = np.isnan(mesh_depth_s)
                    mesh_depth_s[mask] = np.interp(
                        np.flatnonzero(mask), np.flatnonzero(~mask), mesh_depth_s[~mask]
                    )
                    mask = np.isnan(mesh_depth_t)
                    mesh_depth_t[mask] = np.interp(
                        np.flatnonzero(mask), np.flatnonzero(~mask), mesh_depth_t[~mask]
                    )
                    mask = np.isnan(mesh_depth_o)
                    try:
                        mesh_depth_o[mask] = np.interp(
                            np.flatnonzero(mask),
                            np.flatnonzero(~mask),
                            mesh_depth_o[~mask],
                        )
                    ...
                    try:
                        mesh_depth_osat[mask] = np.interp(
                            np.flatnonzero(mask),
                            np.flatnonzero(~mask),
                            mesh_depth_osat[~mask],
                        )
                    except ValueError:  # handles samples with all nan's
                    ...
                    try:
                        mesh_depth_turb[mask] = np.interp(
                            np.flatnonzero(mask),
                            np.flatnonzero(~mask),
                            mesh_depth_turb[~mask],
                        )
                    except ValueError:  # handles samples with all nan's
        ...
        if prawler_interp_time:
            ...
            mesh_grid_sf = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_s,
                kind="linear",
            ...
            mesh_grid_tf = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_t,
                kind="linear",
            ...
            mesh_grid_of = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_o,
                kind="linear",
            ...
            mesh_grid_osatf = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_osat,
                kind="linear",
            ...
            mesh_grid_chlf = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_chl,
                kind="linear",
            ...
            mesh_grid_sigf = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_sig,
                kind="linear",
            ...
            mesh_grid_turbf = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_turb,
                kind="linear",
            ...
            mesh_grid_statsf = interpolate.interp2d(
                press_grid,
                date_time,
                mesh_grid_stats,
                kind="linear",
...
class sbe16(object):
    ...
    def parse(fobj, add_seconds=0, hourly_interp=True, **kwargs):
        ...
        for k, line in enumerate(fobj.readlines()):
            ...
            if "# name" in line:
                var_names[int(line.split("=")[0].split()[-1])] = line.split("=")[
                    1
                ].split()[0]
        ...
        for var_index in sorted(var_id.keys()):
            if var_id[var_index] == "c0mS/cm:":
                ...
                for k, v in sbe16data.items():
                    ...
                    chl_a[k] = float(
                        v[var_index]
                    )  # units are mg/m^3 -> converted to ug/l
            elif var_id[var_index] == "flECO-AFL:":
                print("Processing {0}".format(var_id[var_index]))
                for k, v in sbe16data.items():
                    chl_a[k] = float(
                        v[var_index]
                    )  # units are mg/m^3 -> equivalent to ug/l
            elif var_id[var_index] == "upoly0:":  # likely aanderaa optode
                print("Processing {0}".format(var_id[var_index]))
                for k, v in sbe16data.items():
                    aan_opt_4831[k] = float(
                        v[var_index]
                    )  # units are mg/m^3 -> equivalent to ug/l
            ...
            #### Following ifs are all relevant to a variety of time output fields
                ...
                var_id[var_index] == "timeS:"
            ):  # elapsed time since instrument turned on... not date aware
                print("Processing {0}".format(var_id[var_index]))
                ...
                time_instrument_s = {}
                for k, v in sbe16data.items():
                    time_instrument_s[k] = num2date(
                        float(v[var_index]), "seconds since 2000-01-01"
                    )
        ...
        if kwargs["time_stamp"] == "time_elapsed_s":
            ...
            for k, v in delta_time.items():
                time[k] = v + datetime.datetime.strptime(
        ...
        if hourly_interp:
            ...
            basedate = datetime.datetime(min_t.year, min_t.month, min_t.day, min_t.hour)
            rng = pd.date_range(
                basedate, max(time_corr.values()), freq="H"
            ).to_pydatetime()
            trng = {k: v for k, v in enumerate(rng)}
            data = {
                "Temperature": temp.values(),
                "Pressure": depth.values(),
                "Conductivity": cond.values(),
                "Salinity": sal.values(),
                "Chlor_a": chl_a.values(),
                "PAR": par.values(),
                "OXY_CONC": sbe47_oxyconc.values(),
                "Volts0": V0.values(),
                "AAN_OXY": aan_opt_4831.values(),
            }
            data_interp = interp2hour(
                rng,
                time_corr.values(),
            ...
            return {
                "time": trng,
                "Temperature": data_interp["Temperature"],
                "Pressure": data_interp["Pressure"],
                "Conductivity": data_interp["Conductivity"],
                "Salinity": data_interp["Salinity"],
                "OXY_CONC": data_interp["OXY_CONC"],
                "Chlor_a": data_interp["Chlor_a"],
                "PAR": data_interp["PAR"],
                "Volts0": data_interp["Volts0"],
                "AAN_OXY": data_interp["AAN_OXY"],
            }
        else:
            return {
                "time": time,
...
class sbe26(object):
    ...
    def parse(fobj, **kwargs):
        ...
        rawdata = pd.read_csv(
            fobj, delimiter="\s+", skiprows=1, names=["date", "time", "psia", "degC"]
        )
        rawdata = rawdata.set_index(
            pd.DatetimeIndex(rawdata["date"] + " " + rawdata["time"])
        )
    ...
    def parse(fobj, turbidity=False, pressure=False, version="combined"):
        ...
        if version in ["combined"]:
            ...
            time = {
                k: v.to_pydatetime()
                for k, v in (
                    rawdata["Time tag (Gmt)"].to_dict(into=OrderedDict)
                ).iteritems()
            }
            ...
            rawdata["Time tag (Gmt)"] = rawdata["Time tag (Gmt)"].apply(
                lambda x: datetime.datetime.fromordinal(int(x - 366))
                + datetime.timedelta(days=x - int(x))
            )
            time = {
                k: v.to_pydatetime()
                for k, v in (
...
class rcm(object):
    ...
    def parse(
        ...
        rawdata = pd.read_excel(
            fobj, skiprows=4, parse_dates=["date/time"], index_col="date/time"
        )
        ...
        if interpolate_time:
            rs_data = (
                rawdata.resample(subsampleint_str)
                .mean()
                .interpolate(method="time")
                .resample(sampleint_str)
                .median()
            )
        ...
        time = OrderedDict(
            (k, v.to_pydatetime())
            for k, v in (rs_data["date_time"].to_dict(into=OrderedDict)).iteritems()
        )

        return {
            "time": time,
            "Temperature": rs_data["temperature"].to_dict(into=OrderedDict),
            "Salinity": rs_data["salinity"].to_dict(into=OrderedDict),
            "Pressure": rs_data["pressure"].to_dict(into=OrderedDict),
            "East": rs_data["east true"].to_dict(into=OrderedDict),
            "North": rs_data["north true"].to_dict(into=OrderedDict),
...
class wpak(object):
    ...
    def parse(fobj, argos_file=False):
        ...
        rawdata["date_time"] = pd.to_datetime(
            rawdata["DATE"] + " " + rawdata["TIME"], format="%y/%m/%d %H:%M:%S"
        )

        time = {
            k: v.to_pydatetime()
            for k, v in (rawdata["date_time"].to_dict(into=OrderedDict)).iteritems()
        }

        if not argos_file:
            return {
                "time": time,
                "TA": rawdata["TA"].to_dict(into=OrderedDict),
                "BP": rawdata["BP"].to_dict(into=OrderedDict),
                "BT": rawdata["BT"].to_dict(into=OrderedDict),
                "TI": rawdata["TI"].to_dict(into=OrderedDict),
                "RH": rawdata["RH"].to_dict(into=OrderedDict),
                "WS": rawdata["WS"].to_dict(into=OrderedDict),
                "WD": rawdata["WD"].to_dict(into=OrderedDict),
                "SR": rawdata["SR"].to_dict(into=OrderedDict),
                "AZ": rawdata["AZ"].to_dict(into=OrderedDict),
                "WT": rawdata["WT"].to_dict(into=OrderedDict),
                "WC": rawdata["WC"].to_dict(into=OrderedDict),
                "WT_conv": rawdata["WT_conv"].to_dict(into=OrderedDict),
                "WC_conv": rawdata["WC_conv"].to_dict(into=OrderedDict),
            }
        ...
        for k, line in enumerate(fobj.readlines()):
            ...
            if (k > skiprows + 1) and (new_data == False):
                ...
                if len(line_array) == 5:
                    ...
                    if (
                    ...
                    ) > time_threshold:  # average and start again
                        if ave_scheme == "mean":
                        ...
                        time_ave[index] = (
                            np.sum([(x - tref) for x in dtime]) / len(dtime)
                        ) + tref
                        index += 1
                        new_data = True
...
class adcp_ice(object):
    ...
    def parse(fobj, **kwargs):
        ...
        if kwargs["roundTime"]:
            time = {
                k: roundTime(v.to_pydatetime(), 3600)
                for k, v in (rawdata["date_time"].to_dict(into=OrderedDict)).iteritems()
            }

            return {
                "time": time,
                "U": rawdata["BTVelEast"].to_dict(into=OrderedDict),
                "V": rawdata["BTVelNorth"].to_dict(into=OrderedDict),
                "W": rawdata["BTVelUp"].to_dict(into=OrderedDict),
                "Werr": rawdata["BTVelErr"].to_dict(into=OrderedDict),
