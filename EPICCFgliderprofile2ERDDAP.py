...
try :
    ...
    nchandle.createVariable('profileid','S1',dimensions=('sg_data_point','id_strlen'))
...
print profileid
nchandle.variables['profileid'][:]=stringtochar(np.array(len(nchandle.dimensions['sg_data_point']) * [profileid]))
