...
serial_no=0570
input=${data_dir}${mooringYear}/Moorings/${mooringID}/raw/sbe39/16bs4b_sbe37_570_35m.asc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/16bs4b_s39_0045m.unqcd.nc
