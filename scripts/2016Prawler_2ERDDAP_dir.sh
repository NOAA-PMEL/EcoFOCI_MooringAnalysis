#!/bin/bash
data_dir="/Volumes/WDC_internal/Users/bell/ecoraid/2016/Moorings/16bsitae/initial_archive/erddap/*.nc"
...
for files in $data_dir
do
	python ${prog_dir}NetCDF_ReplaceVarValue.py ${files} latitude 56.868 
