...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bckv2a_s37_0014m.unqcd.cf.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bckv2a_ecf_0016m
