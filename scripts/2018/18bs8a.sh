...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s37_0055m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s37_0031m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s39_0035m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s39_0027m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s39_0050m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s39_0045m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s39_0023m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s39_0067m.unqcd.nc
...
output=${data_dir}${mooringYear}/Moorings/${mooringID}/working/18bs8a_s39_0060m.unqcd.nc
...
python ${prog_dir}EcoFOCIraw2nc.py ${input} ${output}.unqcd.nc eco 0020 -kw 0 median 0.0062 49 False -latlon $lat $lon -add_meta $mooringID $serial_no $site_depth
python ${prog_dir}EcoFOCIraw2nc.py ${input} ${output}.interpolated.nc eco 0020 -kw 5 median 0.0062 49 True -latlon $lat $lon -add_meta $mooringID $serial_no $site_depth
